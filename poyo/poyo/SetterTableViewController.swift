//
//  SetterTableViewController.swift
//  poyo
//
...
UItableViewDelegate protocol SettingViewDelegate {
    func didPrivate(flag: Bool, password: String!)
    func didDate(flag: Bool, date: Int!, dater: NSDate)
}

class SetterTableViewController: UITableViewController, SettingViewDelegate {
