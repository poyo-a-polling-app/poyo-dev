...
class PrivateViewController: UIViewController, CLLocationManagerDelegate, UITableViewDataSource, UITableViewDelegate  {
...
//        self.tableView.separatorStyle = UITableViewCellSeparatorStyle.None
    ...
    func reloadAllData() {
            ...
            if let media = media {
                ...
                for (index, medium) in media.enumerate() {
                    ...
                    if(timeElapsed > timeLimit!) {
                        ...
                        self.privatePoyos!.append(medium)
        ...
        //aslfnsaifnlasfisnaiflnsailnfilnsaifnasf
...
//        print("MASDLASMDLASMDLASMDLLASMDLASDMSALMDLAMSLDLMASD")
    ...
    func countVotes(indexPathrow: Int, option: Int) -> Int {
        ...
        if indexPathrow < self.privatePoyos?.count {
            let poyo = self.privatePoyos![indexPathrow]
            var chosen1vote = 0
            var chosen2vote = 0
...
//        return round(sign * order + seconds / 45000, 7)
    ...
    */
    ...
    func deleteAnswers (indexPath: NSIndexPath) {
        ...
        let poyo = self.privatePoyos![indexPath.row]
...
//                        self.tableView.reloadData()
    ...
    func option1Pressed(sender: subclassedUIButton!) {
        ...
        let poyo = self.privatePoyos![sender.tag]
...
//
//        //search option1Array
//        print(" Finding colors for \(privatePoyos![indexPath.row])")
//
//        let options1Array = privatePoyos![indexPath.row]["option1Answers"] as! [String]
//
...
//
//        //search option2Array
//        let options2Array = privatePoyos![indexPath.row]["option2Answers"] as! [String]
//
...
//
    func findColor(user: PFUser, indexPath: NSIndexPath) -> Int {
        ...
        var options1 = privatePoyos![indexPath.row]["option1Answers"] as! [NSDictionary]
        var options1Array = options1.map { $0["userId"] as! String}
        ...
        var options2 = privatePoyos![indexPath.row]["option2Answers"] as! [NSDictionary]
        var options2Array = options2.map { $0["userId"] as! String}
...
//        reloadAllData()
        ...
        if sender is UIButton {
            ...
            let passPoyo = privatePoyos![sender!.tag]
